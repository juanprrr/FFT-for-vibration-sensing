...
class ArduinoDataPlotter:
    def __init__(self, root):
        ...
        self.acceleration = deque(maxlen=1000)  # Limit the data length to avoid memory issues
        self.velocity = deque(maxlen=1000)
        self.position = deque(maxlen=1000)
    ...
    def start_plotting(self):
        self.plotting = True
        self.root.after(muestreo, self.update_plot)
